...
<<<<<<< HEAD
		<h1 class="titlePages">Inicio</h1>
=======
		<h1 class="titlePages">Home</h1>
...
<<<<<<< HEAD
	<section>
		...
		<h1 class="welcome" style="font-size: 5em; text-align: center; padding-top: 10%;">Bem vindo!</h1>
	</section>
